...
if("TRUE" STREQUAL "TRUE")
  set(simulator_SOURCE_PREFIX /home/froglake/wam_sim_bak/src/simulator)
  set(simulator_DEVEL_PREFIX /home/froglake/wam_sim_bak/devel)
  ...
  set(simulator_INSTALL_PREFIX /home/froglake/wam_sim_bak/install)
...
if(NOT "/home/froglake/wam_sim_bak/src/simulator/include " STREQUAL " ")
  set(simulator_INCLUDE_DIRS "")
  set(_include_dirs "/home/froglake/wam_sim_bak/src/simulator/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'simulator' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Connor Stephens <cjs@ualberta.ca>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'simulator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/froglake/wam_sim_bak/src/simulator/${idir}'.  Ask the maintainer 'Connor Stephens <cjs@ualberta.ca>' to fix it.")
    endif()

...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'barrett_model' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/froglake/wam_sim_bak/src/barrett_model/${idir}'.  Ask the maintainer 'Jonathan Bohren <jbo@jhu.edu>' to fix it.")
    endif()
